//
//  CoreDataToDoListTableViewCell.swift
//  Lesson14
//
...
class CoreDataToDoListTableViewCell: UITableViewCell, ModelTransfer {
    typealias ModelType = TaskCoreDataEntity
    var model: ModelType!
    ...
    func update(with model: TaskCoreDataEntity) {
        self.model = model
    ...
    private func convertDate(date dateInput: Date?) -> String {
